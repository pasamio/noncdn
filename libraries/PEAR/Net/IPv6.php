...
class Net_IPv6
{
    ...
    static function getNetmask($ip, $bits = null)
    {
        if (null==$bits) {
            ...
            if (2 == count($elements)) {
                ...
                throw new RuntimeException(NET_IPV6_NO_NETMASK_MSG,
                                        NET_IPV6_NO_NETMASK);
            }
     ...
     * static function expects an valid IPv6 adress and expands the '::' to
     * the required zeros.
     *
     ...
     *
     * RFC 2373 allows you to compress zeros in an adress to '::'. This
     * static function expects an valid IPv6 adress and compresses successive zeros
     * to '::'
     *
